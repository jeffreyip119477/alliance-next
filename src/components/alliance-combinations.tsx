...
export default memo(function AllianceCombinationsCalculator() {
  ...
  const handleTendererNameChange = useCallback(
  ...
  const handleContractSelectionChange = useCallback(
    ...
    for (let t = 0; t < tenderers; t++) {
      for (let c = 0; c < contracts; c++) {
        if (!selectedContracts[c]) {
          ...
          tempDiscounts[t][c] = tempDiscounts[t][c].slice(
            0,
              ...
              {!showDiscounts ? (
                            ...
                            <TableRow>
                              ...
                              {Array.from({ length: contracts }).map((_, i) => (
                                <TableHead
                                  key={i}
                                  className={
                                    !selectedContracts[i] ? "opacity-50" : ""
                                  }
                                >
                                  C{i + 1}
                                </TableHead>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Enter the discount percentage for each degree of
                      preference (DoP)
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge variant="outline">
                            {formatCurrency(priceMin, true)} -{" "}
                            {formatCurrency(priceMax, true)}
                          </Badge>
                        </div>
                        <Slider
                          id="price-range"
                ...
                <CardContent>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-sm">
                        ...
                        {useAverageDOP &&
                          ...
                          results.dopDifferences.some(
                            ...
                            <div className="flex items-center">
                              <span className="text-[#FF5E93] mr-2">
                                Red text
                              </span>
                  ...
                  <div className="grid gap-4 md:grid-cols-3">
                    ...
                    <div className="p-4 border rounded-lg bg-white dark:bg-gray-800 shadow-sm">
                      ...
                      <div className="text-2xl font-bold">
                        {formatCurrency(
                          results.totalSelectedDiscounted,
                          showAbbreviatedAmounts
                        )}
                      </div>
                    </div>
                                ...
                                {Array.from({ length: contracts }).map(
                                  (_, c) => {
                                    ...
                                    const discountFraction = Number(
                                      (
                                        (results.discounts[t][c][dopIndex] ||
                                          0) / 100
                                      ).toFixed(4)
                                    );
                                    const amount = Number(
                          ...
                          <TableBody>
                            ...
                            <TableRow className="bg-gray-50 dark:bg-gray-800">
                              ...
                              {Array.from({ length: contracts }).map((_, c) => {
                                const columnTotal = results.bestCombo
                                  ?.contractCosts
          ...
          <HistorySidebar
            ...
            onLoadHistory={(item) => {
              ...
              setTimeout(() => {
                ...
                setDiscounts(
                  item.discounts.map((row) => row.map((col) => [...col]))
                );
