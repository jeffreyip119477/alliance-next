...
const HistorySidebar = forwardRef<{ refreshHistory: () => void }, HistorySidebarProps>(
  ({ isOpen, onClose, onLoadHistory }, ref) => {
    ...
    const deleteHistoryItem = (id: string) => {
      try {
        ...
        localStorage.setItem('alliance-calculator-history', JSON.stringify(updatedHistory))
      } catch (error) {
  ...
  return (
    <div className="w-96 bg-white dark:bg-gray-900 border-l border-gray-200 dark:border-gray-700 shadow-lg flex flex-col h-full">
          ...
          <ScrollArea className="h-full">
            {history.length === 0 ? (
              <div className="p-4 text-center text-muted-foreground">
                ...
                <p className="text-sm">Your manual calculations will appear here</p>
              </div>
            ) : (
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                Are you sure you want to delete this calculation from history? This action cannot be undone.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                    ...
                    <CardContent className="pt-0">
                      <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">{formatCurrency(item.totalLowestBase, true)}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Discounted Total:</span>
                          <span className="font-medium">{formatCurrency(item.totalSelectedDiscounted, true)}</span>
                        </div>
                        <div className="flex justify-between">
